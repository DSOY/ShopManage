...
using ShopManage.Sessions;
using ShopManage.Web.Models.Account;
using ShopManage.Web.Views.Shared.Components.TenantChange;

namespace ShopManage.Web.Controllers
{
    public class AccountController : ShopManageControllerBase
    {
